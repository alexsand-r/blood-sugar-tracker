...
export const SmileBad = ({ size = 30, color = "#ffffff" }: IconProps) => {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M50,52.33A37.31,37.31,0,0,0,16.41,73.16l2.68,1.34a34.5,34.5,0,0,1,61.82,0l2.68-1.34A37.31,37.31,0,0,0,50,52.33Z"
      />
    </svg>
  );
};
